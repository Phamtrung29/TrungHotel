  ...
  return (
    <footer class="relative block bg-stone-800 py-12 z-10 ">
      <div class="container flex ">
        <div class="w-6/12 px-5">
          <div class="footer-column footer-about">
            <h3 class="footer-title">KHÁCH SẠN Trung Luxury</h3>
            <ul class="footer-about-text">
              <li>
                <b>Địa chỉ:</b> Số 12 Cầu Giấy, Phường Láng Thượng, Quận Đống
                Đa,Thành phố Hà Nội
              </li>
              <li>
              ...
              <li>
                <b>Email:</b> Sales@atrunghotel.com
              </li>
              <li>
      ...
      <div className="w-full text-center text-xs text-white">
        <p>© Bản quyền 2023 thuộc sở hữu của Khách sạn Trung Luxury</p>
      </div>
    </footer>
  );
};
