    ...
    <section class="about pt-20 pb-10">
      <div class="container flex">
        <div class="mb-7 px-3 w-6/12">
          ...
          <div class="section-subtitle">Trung  Luxury Hotel</div>
          ...
          <p>
          Trung Luxury Hotel là khách sạn chuẩn 5 sao với 24 phòng tiện nghi hiện đại cùng đội ngũ nhân viên chuyên nghiệp cam kết sẽ mang đến mọi du khách một khoảng thời gian đáng nhớ nhất khi đến với khách sạn.
          </p>
